...
{
    public class UnconvertedGeneralRepository<TEntity> : GeneralRepository<TEntity, TEntity>
        where TEntity : class
    {
        public UnconvertedGeneralRepository(DbContext dbContext)
            : base(dbContext)
        {
    ...
    public abstract class GeneralRepository<TDomain, TEntity>
        where TDomain : class
        where TEntity : class
    {
